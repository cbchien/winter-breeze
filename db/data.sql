...
insert into applications (id, created_at, user_id, listing_id, cover_letter) values
	(1, (now() - interval '1 days'), 1, 1, 'Hello, I am Alice'),
	(2, (now() - interval '3 days'), 1, 2, 'Hello, I am Alice'),
    (3, (now() - interval '2 days'), 1, 3, 'Hello, I am Alice'),
    (4, (now() - interval '42 days'), 1, 4, 'Hello, I am Alice'),
    (5, (now() - interval '55 days'), 1, 5, 'Hello, I am Alice'),
    (6, (now() - interval '6 days'), 2, 3, 'Hello, I am Bob'),
    (7, (now() - interval '2 days'), 2, 4, 'Hello, I am Bob'),
    (8, (now() - interval '3 days'), 2, 5, 'Hello, I am Bob'),
    (9, (now() - interval '25 days'), 2, 6, 'Hello, I am Bob'),
    (10, (now() - interval '34 days'), 3, 3, 'Hello, I am Carl'),
    (11, (now() - interval '3 days'), 3, 4, 'Hello, I am Carl'),
    (12, (now() - interval '234 days'), 4, 3, 'Hello!!'),
    (13, (now() - interval '4 days'), 5, 3, 'Hello!'),
    (14, (now() - interval '3 days'), 6, 3, 'Hello!'),
    (15, (now() - interval '23 days'), 7, 4, 'Hello!'),
    (16, (now() - interval '1 days'), 8, 5, 'Hello!'),
    (17, (now() - interval '6 days'), 9, 2, 'Hello!'),
    (18, (now() - interval '4 days'), 10, 1, 'Hello!'),
    (19, (now() - interval '185 days'), 11, 2, 'Hello!'),
    (20, (now() - interval '2 days'), 11, 3, 'Hello!'),
